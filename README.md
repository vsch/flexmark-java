...
```shell
compile 'com.vladsch.flexmark:flexmark-all:0.61.8'
```
...
* Major reorganization and code cleanup of implementation in version 0.61.8, see
  [Version-0.60.0-Changes](../../wiki/Version-0.60.0-Changes)
