...
Document[0, 96]
  BulletList[0, 96] isTight=true
    BulletListItem[0, 5] open:[0, 1, "-"]
      Paragraph[2, 5]
        LinkRef[2, 4] textOpen:[0, 0] text:[0, 0] textClose:[0, 0] referenceOpen:[2, 3, "["] reference:[3, 3] referenceClose:[3, 4, "]"]
    BulletListItem[5, 12] open:[5, 6, "-"]
      Paragraph[7, 12]
        LinkRef[7, 11] textOpen:[0, 0] text:[0, 0] textClose:[0, 0] referenceOpen:[7, 8, "["] reference:[8, 9, "x"] referenceClose:[10, 11, "]"]
          Text[8, 10] chars:[8, 10, "x "]
    BulletListItem[12, 19] open:[12, 13, "-"]
      Paragraph[14, 19]
        LinkRef[14, 18] textOpen:[0, 0] text:[0, 0] textClose:[0, 0] referenceOpen:[14, 15, "["] reference:[16, 17, "x"] referenceClose:[17, 18, "]"]
          Text[15, 17] chars:[15, 17, " x"]
    BulletListItem[19, 27] open:[19, 20, "-"]
      Paragraph[21, 27]
        LinkRef[21, 26] textOpen:[0, 0] text:[0, 0] textClose:[0, 0] referenceOpen:[21, 22, "["] reference:[23, 24, "x"] referenceClose:[25, 26, "]"]
          Text[22, 25] chars:[22, 25, " x "]
    BulletListItem[27, 33] open:[27, 28, "-"]
      Paragraph[29, 33]
        LinkRef[29, 32] textOpen:[0, 0] text:[0, 0] textClose:[0, 0] referenceOpen:[29, 30, "["] reference:[30, 31, "a"] referenceClose:[31, 32, "]"]
          Text[30, 31] chars:[30, 31, "a"]
    BulletListItem[33, 42] open:[33, 34, "-"]
      Paragraph[35, 42]
        LinkRef[35, 38] textOpen:[0, 0] text:[0, 0] textClose:[0, 0] referenceOpen:[35, 36, "["] reference:[37, 37] referenceClose:[37, 38, "]"]
          Text[36, 37] chars:[36, 37, " "]
        Text[38, 41] chars:[38, 41, "abc"]
    BulletListItem[42, 51] open:[42, 43, "-"]
      Paragraph[44, 51]
        LinkRef[44, 47] textOpen:[0, 0] text:[0, 0] textClose:[0, 0] referenceOpen:[44, 45, "["] reference:[45, 46, "x"] referenceClose:[46, 47, "]"]
          Text[45, 46] chars:[45, 46, "x"]
        Text[47, 50] chars:[47, 50, "abc"]
    BulletListItem[51, 60] open:[51, 52, "-"]
      Paragraph[53, 60]
        LinkRef[53, 56] textOpen:[0, 0] text:[0, 0] textClose:[0, 0] referenceOpen:[53, 54, "["] reference:[54, 55, "x"] referenceClose:[55, 56, "]"]
          Text[54, 55] chars:[54, 55, "x"]
        Text[56, 59] chars:[56, 59, "abc"]
    BulletListItem[60, 72] open:[60, 61, "-"]
      Paragraph[62, 72]
        Text[62, 63] chars:[62, 63, "a"]
        LinkRef[63, 66] textOpen:[0, 0] text:[0, 0] textClose:[0, 0] referenceOpen:[63, 64, "["] reference:[65, 65] referenceClose:[65, 66, "]"]
          Text[64, 65] chars:[64, 65, " "]
        Text[66, 71] chars:[66, 71, " task"]
    BulletListItem[72, 84] open:[72, 73, "-"]
      Paragraph[74, 84]
        Text[74, 75] chars:[74, 75, "b"]
        LinkRef[75, 78] textOpen:[0, 0] text:[0, 0] textClose:[0, 0] referenceOpen:[75, 76, "["] reference:[76, 77, "x"] referenceClose:[77, 78, "]"]
          Text[76, 77] chars:[76, 77, "x"]
        Text[78, 83] chars:[78, 83, " task"]
    BulletListItem[84, 96] open:[84, 85, "-"]
      Paragraph[86, 96]
        Text[86, 87] chars:[86, 87, "c"]
        LinkRef[87, 90] textOpen:[0, 0] text:[0, 0] textClose:[0, 0] referenceOpen:[87, 88, "["] reference:[88, 89, "x"] referenceClose:[89, 90, "]"]
