...
public class ComboWikiLinkTranslationFormatterSpecTest extends TranslationFormatterSpecTest {
    final private static String SPEC_RESOURCE = "/ext_wikilink_translation_formatter_spec.md";
    ...
    public ComboWikiLinkTranslationFormatterSpecTest(@NotNull SpecExample example) {
