...
public class HtmlDeepParserTest {
  ...
  public void test_openBlock() {
    ...
    assertTrue(deepParser.hadHtml());
    assertFalse(deepParser.isHtmlClosed());
    assertFalse(deepParser.isBlankLineInterruptible());
    assertFalse(deepParser.haveOpenRawTag());
  }
  ...
  public void test_closedBlock() {
    ...
    assertTrue(deepParser.hadHtml());
    assertTrue(deepParser.isHtmlClosed());
    assertTrue(deepParser.isBlankLineInterruptible());
    assertFalse(deepParser.haveOpenRawTag());
  }
  ...
  public void test_openBlockOneLine() {
    ...
    assertFalse(deepParser.hadHtml());
    assertTrue(deepParser.isHtmlClosed());
    assertTrue(deepParser.isBlankLineInterruptible());
    assertFalse(deepParser.haveOpenRawTag());
  }
  ...
  public void test_openComment() {
    ...
    assertFalse(deepParser.isHtmlClosed());
    assertFalse(deepParser.isBlankLineInterruptible());
    assertTrue(deepParser.haveOpenRawTag());
  }
