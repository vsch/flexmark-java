...
public class ComboCommonMarkCompatibilitySpecTest extends ComboExtraSpecTest {
    private static final String SPEC_RESOURCE = "/commonmark_compatibility_spec.md";
