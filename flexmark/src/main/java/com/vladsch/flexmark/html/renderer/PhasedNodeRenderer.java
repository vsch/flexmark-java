...
public interface PhasedNodeRenderer extends NodeRenderer {
   ...
   *     RenderingPhase} no rendering should be done if phase is {@link RenderingPhase#BODY} because
   *     this phase is used for the non-phased node rendering. For body phase this method is called
   *     before the node renderer calls are made so it is a good place to reset internal structures
