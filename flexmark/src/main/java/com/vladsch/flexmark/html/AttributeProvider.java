...
/**
 * Extension point for adding/changing attributes on the primary HTML tag for a ast.
 */
public interface AttributeProvider {

    /**
     * Set the attributes for the ast by modifying the provided map.
     * <p>
     ...
     * <p>
     * Also used to get the id attribute for the ast. Specifically for heading nodes. When the part parameter
     ...
     * <p>
     * AttributablePart.NODE is a generic placeholder when the ast did not provide a specific part for attribution.
     *
     * @param node       the ast to set attributes for
     * @param part       attributes for the specific part of the ast being generated, Core defines AttributablePart.LINK,
