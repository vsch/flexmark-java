...
public class CoreNodeRenderer implements NodeRenderer {
    ...
    public Set<NodeRenderHandler<?>> getNodeRenderers() {
        return new HashSet<>(Arrays.asList(
                new NodeRenderHandler<>(AutoLink.class, this::render),
                new NodeRenderHandler<>(BlockQuote.class, this::render),
                new NodeRenderHandler<>(BulletList.class, this::render),
                new NodeRenderHandler<>(Code.class, this::render),
                new NodeRenderHandler<>(Document.class, this::render),
                new NodeRenderHandler<>(Emphasis.class, this::render),
                new NodeRenderHandler<>(FencedCodeBlock.class, this::render),
                new NodeRenderHandler<>(HardLineBreak.class, this::render),
                new NodeRenderHandler<>(Heading.class, this::render),
                new NodeRenderHandler<>(HtmlBlock.class, this::render),
                new NodeRenderHandler<>(HtmlCommentBlock.class, this::render),
                new NodeRenderHandler<>(HtmlEntity.class, this::render),
                new NodeRenderHandler<>(HtmlInline.class, this::render),
                new NodeRenderHandler<>(HtmlInlineComment.class, this::render),
                new NodeRenderHandler<>(Image.class, this::render),
                new NodeRenderHandler<>(ImageRef.class, this::render),
                new NodeRenderHandler<>(IndentedCodeBlock.class, this::render),
                new NodeRenderHandler<>(Link.class, this::render),
                new NodeRenderHandler<>(LinkRef.class, this::render),
                new NodeRenderHandler<>(BulletListItem.class, this::render),
                new NodeRenderHandler<>(OrderedListItem.class, this::render),
                new NodeRenderHandler<>(MailLink.class, this::render),
                new NodeRenderHandler<>(OrderedList.class, this::render),
                new NodeRenderHandler<>(Paragraph.class, this::render),
                new NodeRenderHandler<>(Reference.class, this::render),
                new NodeRenderHandler<>(SoftLineBreak.class, this::render),
                new NodeRenderHandler<>(StrongEmphasis.class, this::render),
                new NodeRenderHandler<>(Text.class, this::render),
                new NodeRenderHandler<>(ThematicBreak.class, this::render)
        ));
    }
