...
public interface NodeFormatterFactory extends Dependent {
  ...
  /**
   * @return null or a list of processors before which this has to be run if any of the blocks in
   *     the list affect global state then these will be run on ALL blocks of the document before
