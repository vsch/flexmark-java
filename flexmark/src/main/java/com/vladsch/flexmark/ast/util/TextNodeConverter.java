...
public class TextNodeConverter {
    ...
    public void appendChild(Node child) {
        ...
        assert nodeChars.contains(childChars) : "child " + child.toAstString(false) + " is not within parent sequence " + Node.toSegmentSpan(nodeChars, null);
        assert remainingChars.contains(childChars) : "child " + child.toAstString(false) + " is not within remaining sequence " + Node.toSegmentSpan(remainingChars, null);
        child.unlink();
