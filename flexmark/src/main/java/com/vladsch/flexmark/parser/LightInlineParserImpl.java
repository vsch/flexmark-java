...
public class LightInlineParserImpl implements LightInlineParser {
  ...
  /**
   * If RE matches at current index in the input, advance index and return the match; otherwise
   * return null.
   *
  ...
  /**
   * @return the char at the current input index, or {@code '\0'} in case there are no more
   *     characters.
   */
  @Override
  public char peek() {
