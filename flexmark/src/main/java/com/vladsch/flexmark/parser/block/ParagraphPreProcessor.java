...
public interface ParagraphPreProcessor {
   ...
   *
   * <p>This is used by extensions to take leading lines from a paragraph and convert them to other
   * blocks
   *
   * <p>by Default leading lines that define references are removed and Reference nodes are inserted
   * before.
   *
