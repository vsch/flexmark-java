 ...
 *
 * <p>Partial repeat occurs when start % length() &gt;0 and/or end % length() &gt;0
 *
      ...
      return (startIndex == endIndex)
          ...
          : startIndex == this.startIndex && endIndex == this.endIndex
              ...
              : new RepeatedSequence(
                  chars, this.startIndex + startIndex, this.startIndex + endIndex);
    }

    throw new IllegalArgumentException(
        "subSequence($startIndex, $endIndex) in RepeatedCharSequence('', "
            + this.startIndex
            + ", "
            + this.endIndex
            + ")");
