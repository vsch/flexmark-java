...
public class MarkdownTable {
  ...
  private final ArrayList<TrackedOffset> trackedOffsets = new ArrayList<>();
  ...
  public static final NumericSuffixPredicate ALL_SUFFIXES_NO_SORT =
      new NumericSuffixPredicate() {
        ...
        @Override
        public boolean sortSuffix(String suffix) {
          return false;
        }
      };

  public MarkdownTable(CharSequence tableChars, TableFormatOptions options) {
