...
public interface TableCellManipulator {
   ...
   *     index)
   * @param allCellIndex cell's index as would be at the beginning of the request, deleted cell
   *     indices skipped
   * @return change to cells &lt;0 of cells deleted, &gt;0 number inserted, 0 no change, or BREAK to
   *     stop processing cells
   */
