...
#echo updated out/artifacts/flexmark-test-util.jar  ../plugin-utils/lib
#cp out/artifacts/flexmark-formatter.jar  ../plugin-utils/lib
#echo updated out/artifacts/flexmark-formatter.jar  ../plugin-utils/lib
