...
public class JiraZzzzzzSpecTest extends ComboSpecTestCase {
    private static final String SPEC_RESOURCE = "/ext_zzzzzz_ast_spec.md";
    private static final DataHolder OPTIONS = new MutableDataSet()
            .set(HtmlRenderer.INDENT_SIZE, 2)
            //.set(HtmlRenderer.PERCENT_ENCODE_URLS, true)
            .set(Parser.EXTENSIONS, Arrays.asList(JiraConverterExtension.create(), ZzzzzzExtension.create()));
    ...
    public JiraZzzzzzSpecTest(SpecExample example) {
        super(example);
    }
