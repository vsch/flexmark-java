...
public class ZzzzzzVisitorExt {
    static <V extends ZzzzzzVisitor> VisitHandler<?>[] VISIT_HANDLERS(final V visitor) {
        return new VisitHandler<?>[] {
// @formatter:off
                new VisitHandler<>(Zzzzzz.class, new Visitor<Zzzzzz>() { @Override public void visit(Zzzzzz node) { visitor.visit(node); } }),// zzzoptionszzz(CUSTOM_BLOCK_NODE)
