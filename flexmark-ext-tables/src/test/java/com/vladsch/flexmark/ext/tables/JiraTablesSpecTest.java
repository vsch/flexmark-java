...
public class JiraTablesSpecTest extends ComboSpecTestCase {
    static final String SPEC_RESOURCE = "/ext_tables_jira_spec.md";
    private static final DataHolder OPTIONS = new MutableDataSet()
            .set(HtmlRenderer.INDENT_SIZE, 2)
            //.set(HtmlRenderer.PERCENT_ENCODE_URLS, true)
            .set(Parser.EXTENSIONS, Arrays.asList(JiraConverterExtension.create(), TablesExtension.create()));
    ...
    public JiraTablesSpecTest(SpecExample example) {
        super(example);
    }
