...
public class MarkdownTableTestBase {
  ...
  protected void assertIndexOf(
      int expIndex, int expSpanOffset, MarkdownTable.IndexSpanOffset index) {
    assertEquals(
        new MarkdownTable.IndexSpanOffset(expIndex, expSpanOffset).toString(), index.toString());
  }

  protected void assertIndexOf(
      String message, int expIndex, int expSpanOffset, MarkdownTable.IndexSpanOffset index) {
    assertEquals(
        message,
        new MarkdownTable.IndexSpanOffset(expIndex, expSpanOffset).toString(),
        index.toString());
  }
