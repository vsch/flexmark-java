...
public class ComboTableManipulationSpecTest extends ComboSpecTestCase {
    ...
    static {
        ...
        optionsMap.put("move-col-7-8", new MutableDataSet().set(TablesExtension.FORMAT_TABLE_MANIPULATOR, new TableManipulator() {@Override public void apply(final MarkdownTable table, final Node tableNoe) { table.moveColumn(6, 7);}}));
        optionsMap.put("move-col-8-9", new MutableDataSet().set(TablesExtension.FORMAT_TABLE_MANIPULATOR, new TableManipulator() {@Override public void apply(final MarkdownTable table, final Node tableNoe) { table.moveColumn(7, 8);}}));
        ...
        optionsMap.put("move-col-7-6", new MutableDataSet().set(TablesExtension.FORMAT_TABLE_MANIPULATOR, new TableManipulator() {@Override public void apply(final MarkdownTable table, final Node tableNoe) { table.moveColumn(6, 5);}}));
        optionsMap.put("move-col-8-7", new MutableDataSet().set(TablesExtension.FORMAT_TABLE_MANIPULATOR, new TableManipulator() {@Override public void apply(final MarkdownTable table, final Node tableNoe) { table.moveColumn(7, 6);}}));
        optionsMap.put("move-col-9-8", new MutableDataSet().set(TablesExtension.FORMAT_TABLE_MANIPULATOR, new TableManipulator() {@Override public void apply(final MarkdownTable table, final Node tableNoe) { table.moveColumn(8, 7);}}));
