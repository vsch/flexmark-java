...
public class YouTrackStrikethroughSpecTest extends ComboSpecTestCase {
    static final String SPEC_RESOURCE = "/ext_gfm_strikethrough_youtrack_spec.md";
    private static final DataHolder OPTIONS = new MutableDataSet()
            .set(HtmlRenderer.INDENT_SIZE, 0)
            //.set(HtmlRenderer.PERCENT_ENCODE_URLS, true)
            .set(Parser.EXTENSIONS, Arrays.asList(YouTrackConverterExtension.create(), StrikethroughExtension.create()));
    ...
    public YouTrackStrikethroughSpecTest(SpecExample example) {
        super(example);
    }
