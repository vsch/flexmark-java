...
public class JiraStrikethroughSpecTest extends ComboSpecTestCase {
    static final String SPEC_RESOURCE = "/ext_gfm_strikethrough_jira_spec.md";
    private static final DataHolder OPTIONS = new MutableDataSet()
            .set(HtmlRenderer.INDENT_SIZE, 0)
            //.set(HtmlRenderer.PERCENT_ENCODE_URLS, true)
            .set(Parser.EXTENSIONS, Arrays.asList(JiraConverterExtension.create(), StrikethroughExtension.create()));
    ...
    public JiraStrikethroughSpecTest(SpecExample example) {
        super(example);
    }
