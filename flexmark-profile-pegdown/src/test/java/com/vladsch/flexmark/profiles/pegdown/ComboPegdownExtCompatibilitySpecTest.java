...
public class ComboPegdownExtCompatibilitySpecTest extends ComboExtraSpecTest {
    private static final String SPEC_RESOURCE = "/pegdown_ext_compatibility_spec.md";
    ...
    public ComboPegdownExtCompatibilitySpecTest(SpecExample example) {
        super(example);
    }
