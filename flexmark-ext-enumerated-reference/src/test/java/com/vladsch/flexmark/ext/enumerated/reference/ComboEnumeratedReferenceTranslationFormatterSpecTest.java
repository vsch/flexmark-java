...
public class ComboEnumeratedReferenceTranslationFormatterSpecTest extends ComboSpecTestCase {
    ...
    static {
        ...
        //optionsMap.put("references-no-sort", new MutableDataSet().set(EnumeratedReferenceExtension.ENUMERATED_REFERENCE_PLACEMENTELEMENTPLACEMENTSORT.AS_IS));
