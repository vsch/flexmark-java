...
public class MarkdownFormattingAppendableBase<T extends MarkdownFormattingAppendableBase> implements MarkdownFormattingAppendable {
    ...
    public MarkdownFormattingAppendableBase(Appendable out) {
        this(out, 0, false);
    }

    public MarkdownFormattingAppendableBase(FormattingAppendable other, Appendable out, boolean inheritIndent) {
        this(out, inheritIndent ? other.getIndentPrefix().length() : 0, false);
    }

    public MarkdownFormattingAppendableBase(Appendable out, int indentSize, final boolean allFormatOptions) {
    ...
    public MarkdownFormattingAppendableBase(Appendable out, int indentSize, final int formatOptions) {
    ...
    @Override
    public MarkdownFormattingAppendable withAttr() {
        withAttributes = true;
        return (T) this;
    }
