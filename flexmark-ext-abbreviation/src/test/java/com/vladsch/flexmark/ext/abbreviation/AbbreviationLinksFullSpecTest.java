...
public class AbbreviationLinksFullSpecTest extends FullSpecTestCase {
    static final String SPEC_RESOURCE = "/ext_abbreviation_links_ast_spec.txt";
    private static final Set<Extension> EXTENSIONS = Collections.singleton(AbbreviationExtension.create(true));
