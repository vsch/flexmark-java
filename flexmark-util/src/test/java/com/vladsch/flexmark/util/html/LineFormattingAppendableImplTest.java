...
public class LineFormattingAppendableImplTest {
    ...
    public void test_appendCharSb() throws Exception {
        ...
        LineAppendable fa = new LineFormattingAppendableImpl(LineAppendable.F_FORMAT_ALL);
        ...
        sb = new StringBuilder();
        fa = new LineFormattingAppendableImpl(LineAppendable.F_FORMAT_ALL);
    ...
    public void test_indent() {
        String indent = " ";
        LineAppendable fa = new LineFormattingAppendableImpl(LineAppendable.F_FORMAT_ALL).setIndentPrefix(indent);
        ...
        fa = new LineFormattingAppendableImpl(LineAppendable.F_FORMAT_ALL).setIndentPrefix(indent);
        fa.append("abc").indent().unIndent();
        assertEquals("abc\n", fa.toString(0));
