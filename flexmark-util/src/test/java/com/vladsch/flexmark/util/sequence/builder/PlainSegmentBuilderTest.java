...
public class PlainSegmentBuilderTest {
  ...
  public void test_basicBuildEmpty() {
    ...
    assertEquals(
        "PlainSegmentBuilder{NULL, s=0:0, u=0:0, t=0:0, l=0, sz=0, na=0 }",
  ...
  public void test_basicEmptyDefaults() {
    ...
    assertEquals(
        "PlainSegmentBuilder{[0, 10), s=0:0, u=0:0, t=0:0, l=0, sz=2, na=0: [0), [10) }",
        segments.toStringPrep());
    assertEquals(segments.toString(sequence).length(), segments.length());
  }
  ...
  public void test_basicEmptyNoAnchors() {
    ...
    assertEquals(0, segments.length());
    assertEquals(
        "PlainSegmentBuilder{[0, 10), s=0:0, u=0:0, t=0:0, l=0, sz=0, na=0 }",
        segments.toStringPrep());
    assertEquals(segments.toString(sequence).length(), segments.length());
  }
  ...
  public void test_basicPrefix() {
    ...
    assertEquals(
        "PlainSegmentBuilder{[0, 4), s=1:2, u=1:2, t=1:2, l=6, sz=2, na=2: a:2x' ', [0, 4) }",
        segments.toStringPrep());
    assertEquals(segments.toString(sequence).length(), segments.length());
  ...
  public void test_basicAnchorAfterEnd() {
    ...
    assertEquals(
        "PlainSegmentBuilder{[0, 5), s=1:2, u=1:2, t=1:2, l=6, sz=3, na=2: a:2x' ', [0, 4), [5) }",
        segments.toStringPrep());
    assertEquals(segments.toString(sequence).length(), segments.length());
  ...
  public void test_appendRange1() {
    ...
    assertEquals(
        "PlainSegmentBuilder{[0, 4), s=0:0, u=0:0, t=0:0, l=4, sz=1, na=1: [0, 4) }",
        segments.toStringPrep());
    assertEquals(segments.toString(sequence).length(), segments.length());
  ...
  public void test_appendRangeNonOverlapping() {
    ...
    assertEquals(
        "PlainSegmentBuilder{[0, 7), s=0:0, u=0:0, t=0:0, l=5, sz=2, na=2: [0, 4), [6, 7) }",
        segments.toStringPrep());
    assertEquals(segments.toString(sequence).length(), segments.length());
  ...
  public void test_appendRangeOverlapping() {
    ...
    assertEquals(
        "PlainSegmentBuilder{[0, 7), s=0:0, u=0:0, t=0:0, l=7, sz=1, na=1: [0, 7) }",
        segments.toStringPrep());
    assertEquals(segments.toString(sequence).length(), segments.length());
  ...
  public void test_handleOverlapDefaultChop1() {
    ...
    segments.append(4, 8);
    assertEquals(
        "PlainSegmentBuilder{[2, 8), s=0:0, u=1:1, t=1:1, l=7, sz=3, na=3: [2, 5), a:'-', [5, 8) }",
        segments.toStringPrep());
  ...
  public void test_handleOverlapDefaultChop3() {
    ...
    segments.append(3, 5);
    assertEquals(
        "PlainSegmentBuilder{[2, 5), s=0:0, u=1:1, t=1:1, l=4, sz=3, na=2: [2, 5), a:'-', [5) }",
        segments.toStringPrep());
    assertEquals(segments.toString(sequence).length(), segments.length());
  }
  ...
  public void test_handleOverlapDefaultMerge1() {
    ...
    segments.append(4, 8);
    assertEquals(
        "PlainSegmentBuilder{[2, 8), s=0:0, u=0:0, t=0:0, l=6, sz=1, na=1: [2, 8) }",
        segments.toStringPrep());
    assertEquals(segments.toString(sequence).length(), segments.length());
  }
  ...
  public void test_handleOverlapDefaultMerge3() {
    ...
    segments.append(3, 5);
    assertEquals(
        "PlainSegmentBuilder{[2, 5), s=0:0, u=0:0, t=0:0, l=3, sz=1, na=1: [2, 5) }",
        segments.toStringPrep());
    assertEquals(segments.toString(sequence).length(), segments.length());
  }
  ...
  */
  ...
  private static class OptimizedSegmentBuilder2 extends PlainSegmentBuilder {
    ...
    @NotNull
    public static OptimizedSegmentBuilder2 emptyBuilder(
        CharSequence base, CharRecoveryOptimizer optimizer) {
  ...
  public void test_optimizerExtendPrev1() {
    ...
    assertEquals(
        "OptimizedSegmentBuilder2{[0, 10), s=0:0, u=0:0, t=0:0, l=10, sz=1, na=1: [0, 10) }",
        segments.toStringPrep());
    assertEquals(segments.toString(sequence).length(), segments.length());
  }
  ...
  public void test_optimizersIndent1None() {
    ...
    assertEquals(
        "OptimizedSegmentBuilder2{[0, 12), s=1:2, u=1:2, t=1:2, l=14, sz=2, na=2: a:2x' ', [0, 12) }",
        segments.toStringPrep());
    assertEquals(segments.toString(sequence).length(), segments.length());
  }
  ...
  public void test_optimizers2() {
    ...
    segments.append("\n");
    assertEquals(
        "OptimizedSegmentBuilder2{[0, 7), s=0:0, u=0:0, t=0:0, l=6, sz=2, na=2: [0, 5), [6, 7) }",
        segments.toStringPrep());
    assertEquals(segments.toString(sequence).length(), segments.length());
  }
  ...
  public void test_optimizers2a() {
    ...
    segments.append(" \n");
    assertEquals(
        "OptimizedSegmentBuilder2{[0, 8), s=0:0, u=0:0, t=0:0, l=7, sz=2, na=2: [0, 6), [7, 8) }",
        segments.toStringPrep());
    assertEquals(segments.toString(sequence).length(), segments.length());
  }
  ...
  public void test_optimizersCompoundNoAnchors1() {
    ...
    OptimizedSegmentBuilder2 segments =
        OptimizedSegmentBuilder2.emptyBuilder(sequence, optimizer, F_TRACK_FIRST256);
