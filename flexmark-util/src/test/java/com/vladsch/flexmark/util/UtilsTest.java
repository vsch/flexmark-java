...
public class UtilsTest {
    ...
    public void testParseIntOrNull() {
        assertEquals(new Integer(3), Utils.parseIntOrNull("3"));
    ...
    public void testParseUnsignedIntOrNull() {
        ...
        assertEquals(new Integer(23_333_333), Utils.parseUnsignedIntOrNull("23333333"));
        assertEquals(new Integer(3), Utils.parseUnsignedIntOrNull("3"));
        assertEquals(new Integer(63), Utils.parseUnsignedIntOrNull("63"));
        assertEquals(new Integer(0), Utils.parseUnsignedIntOrNull("0"));

        assertEquals((Integer) 0, Utils.parseUnsignedIntOrNull("-0"));
    }
