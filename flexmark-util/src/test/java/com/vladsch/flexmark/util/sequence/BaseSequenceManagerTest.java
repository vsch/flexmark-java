...
public class BaseSequenceManagerTest {
    ...
    public void test_Reuse() {
        ...
        BasedSequence sequence1 = manager.getBaseSequence(input1, callType, seq -> BasedSequenceImpl.create(seq));
        BasedSequence sequence2 = manager.getBaseSequence(input2, callType, seq -> BasedSequenceImpl.create(seq));
        BasedSequence sequence3 = manager.getBaseSequence(input3, callType, seq -> BasedSequenceImpl.create(seq));
        BasedSequence sequence4 = manager.getBaseSequence(input4, callType, seq -> BasedSequenceImpl.create(seq));
        BasedSequence sequence5 = manager.getBaseSequence(input5, callType, seq -> BasedSequenceImpl.create(seq));
    ...
    public void test_Release() {
        ...
        BasedSequence sequence1 = manager.getBaseSequence("0123456789", callType, seq -> BasedSequenceImpl.create(seq));
...
//        System.out.println("CallType: " + callType[0]);
        ...
        BasedSequence sequence2 = manager.getBaseSequence("0123456789", callType, seq -> BasedSequenceImpl.create(seq));
        assertEquals(0, callType[0]);

        BasedSequence sequence3 = manager.getBaseSequence("0123456789", callType, seq -> BasedSequenceImpl.create(seq));
        assertEquals(0, callType[0]);

        BasedSequence sequence4 = manager.getBaseSequence("012345678", callType, seq -> BasedSequenceImpl.create(seq));
        assertTrue(callType[0] <= 21);

        BasedSequence sequence5 = manager.getBaseSequence("1234567890", callType, seq -> BasedSequenceImpl.create(seq));
        assertTrue(callType[0] <= 21);

        sequence5 = manager.getBaseSequence("1234567890", callType, seq -> BasedSequenceImpl.create(seq));
        assertEquals(0, callType[0]);
        ...
        System.gc();
        sequence1 = manager.getBaseSequence("0123456789", callType, seq -> BasedSequenceImpl.create(seq));
        assertEquals(0, callType[0]);
