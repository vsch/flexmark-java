...
public class DocumentTest {
    ...
    Document document =
        new Document(
            ...
            BasedSequence.of("Hello\nWorld")
                .subSequence(0, ((CharSequence) "Hello\nWorld").length()));
  ...
  public void testLineNumberWithOldMacEol() {
    Document document =
        new Document(
            new MutableDataSet(),
            BasedSequence.of("Hello\rWorld")
                .subSequence(0, ((CharSequence) "Hello\rWorld").length()));
  ...
  public void testLineNumberWithOldMacEol2() {
    Document document =
        new Document(
            new MutableDataSet(),
            BasedSequence.of("Hello\r\rWorld")
                .subSequence(0, ((CharSequence) "Hello\r\rWorld").length()));
