...
public class LineAppendableImplTest {
  ...
  public void test_leadingEOL() throws Exception {
    StringBuilder sb = new StringBuilder();
    LineAppendable fa =
        new LineAppendableImpl(LineAppendable.F_FORMAT_ALL & ~LineAppendable.F_TRIM_LEADING_EOL);
  ...
  public void test_openPreFormatted() {
    ...
    fa.indent()
        ...
        .unIndent();
    assertEquals(
        "  <p>this is a paragraph <div style=''>    some text\n    some more text\n  </div>\n",
        fa.toString(0, 0));
  ...
  public void test_prefixAfterEol() {
    ...
    assertEquals(
        "Line: " + 2,
        PrefixedSubSequence.prefixOf("  ", sequence.subSequence(2 * 10, 2 * 10 + 10)),
        fa.getLine(2));
    assertEquals(
        "Line: " + 3,
        PrefixedSubSequence.prefixOf("  ", sequence.subSequence(3 * 10, 3 * 10 + 10)),
        fa.getLine(3));
    assertEquals("Line: " + 4, sequence.subSequence(4 * 10, 4 * 10 + 10), fa.getLine(4));
  ...
  public void test_prefix() {
    ...
    assertEquals(
        "Line: " + 1,
        PrefixedSubSequence.prefixOf("  ", sequence.subSequence(1 * 10, 1 * 10 + 10)),
        fa.getLine(1));
    assertEquals(
        "Line: " + 2,
        PrefixedSubSequence.prefixOf("  ", sequence.subSequence(2 * 10, 2 * 10 + 10)),
  ...
  public void test_insertLineFirstBlank() {
    ...
    assertEquals(
        "Line: " + 0,
        "LineInfo{i=0, pl=0, tl=0, l=1, sumPl=0, sumTl=0, sumL=1, bp bt, '\\n'}",
        fa.getLineInfo(0).toString());
    assertEquals(
        "Line: " + 1,
  ...
  public void test_insertLineFirstPrefixedBlank() {
    ...
    assertEquals(
        "Line: " + 0,
        "LineInfo{i=0, pl=1, tl=0, l=2, sumPl=1, sumTl=0, sumL=2, bt, '>\\n'}",
        fa.getLineInfo(0).toString());
    assertEquals(
        "Line: " + 1,
  ...
  public void test_appendLineAppendablePrefixedUnterminated() {
    ...
    assertEquals("" + "> 0:2343568" + "", fa.toString());

    fa2.setPrefix("  ", false);
    fa2.append(fa);
    assertEquals("" + "  > 0:2343568" + "", fa2.toString());

    assertEquals("0", "" + "  > 0:2343568" + "", fa2.toString());

    fa2.append("|abc").line();
    assertEquals("0", "" + "  > 0:2343568|abc\n" + "", fa2.toString());
  }
  ...
  public void test_appendLineAppendableMapped() {
    ...
    assertEquals(
        "⟦⟧> ⟦[simLink⟧\u00A0⟦spaced](simLink.md)⟧", actualBuilder.toStringWithRanges(true));
