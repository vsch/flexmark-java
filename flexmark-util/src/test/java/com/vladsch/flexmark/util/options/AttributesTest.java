...
public class AttributesTest {
  ...
  public void testBasic() {
    ...
    assertEquals("contains old value", true, attributes.containsValue("class", "class1"));
    assertEquals(
        "does not contain removed value", false, attributes.containsValue("class", "class2"));
    ...
    assertEquals(
        "does not contain removed value", false, attributes.containsValue("class", "class2"));
    assertEquals(
        "does not contain removed value", false, attributes.containsValue("class", "class3"));

    attributes.removeValue("class", "class1");
    assertEquals("removed value", "", attributes.getValue("class"));
    assertEquals("contains removed value attribute", true, attributes.contains("class"));
    assertEquals(
        "does not contain removed value", false, attributes.containsValue("class", "class1"));
    assertEquals(
        "does not contain removed value", false, attributes.containsValue("class", "class2"));
    assertEquals(
        "does not contain removed value", false, attributes.containsValue("class", "class3"));
