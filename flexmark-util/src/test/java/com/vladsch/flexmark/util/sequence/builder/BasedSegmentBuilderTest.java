...
public class BasedSegmentBuilderTest {
  ...
  public void test_basicBuildEmpty() {
    ...
    assertEquals(
        "BasedSegmentBuilder{NULL, s=0:0, u=0:0, t=0:0, l=0, sz=0, na=0 }",
  ...
  public void test_basicEmptyNoAnchors() {
    ...
    assertEquals(0, segments.length());
    assertEquals(
        "BasedSegmentBuilder{[0, 10), s=0:0, u=0:0, t=0:0, l=0, sz=0, na=0 }",
        escapeJavaString(segments.toStringPrep()));
    assertEquals(segments.toString(sequence).length(), segments.length());
  }
  ...
  */
  ...
  public void test_optimizerExtendPrev1() {
    ...
    BasedSegmentBuilder segments =
        BasedSegmentBuilder.emptyBuilder(sequence, optimizer, F_INCLUDE_ANCHORS | F_TRACK_FIRST256);
  ...
  public void test_extractRangesDefault() {
    ...
    assertEquals(
        escapeJavaString(
            "BasedSegmentBuilder{[0, 10), s=0:0, u=0:0, t=0:0, l=6, sz=3, na=3: [0, 1), [3, 6), [8, 10) }"),
        escapeJavaString(segments.toStringPrep()));
    assertEquals(segments.toString(sequence).length(), segments.length());
  ...
  public void test_replacePrefixDefault() {
    ...
    assertEquals(
        escapeJavaString(
            "BasedSegmentBuilder{[0, 10), s=0:0, u=1:1, t=1:1, l=10, sz=3, na=2: [0), a:'^', [1, 10) }"),
        escapeJavaString(segments.toStringPrep()));
    assertEquals(segments.toString(sequence).length(), segments.length());
  ...
  public void test_replacePrefixNoAnchors() {
    ...
    assertEquals(
        escapeJavaString(
            "BasedSegmentBuilder{[0, 10), s=0:0, u=1:1, t=1:1, l=10, sz=2, na=2: a:'^', [1, 10) }"),
        escapeJavaString(segments.toStringPrep()));
    assertEquals(segments.toString(sequence).length(), segments.length());
    assertEquals("^123456789", segments.toString(sequence));
  }
