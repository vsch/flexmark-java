...
public class SegmentedSequenceTreeTest {
  ...
  public void test_lastIndexOf() {
    ...
    for (int i = 0; i < iMax; i++) {
      ...
      for (int j = i; j < iMax; j++) {
        assertEquals(
            "lastIndexOf('" + c + "', " + j + ")", s1.lastIndexOf(c, j), s.lastIndexOf(c, j));
        for (int k = iMax; k-- > j; ) {
          final int lastIndexOf = s1.lastIndexOf(c, k);
          assertEquals(
              "lastIndexOf('" + c + "', " + j + ", " + k + ")",
              lastIndexOf < j ? -1 : lastIndexOf,
              s.lastIndexOf(c, j, k));
        }
      }
    }
  ...
  public void test_blankLinesRange() {
    ...
    assertEquals(
        Range.of(0, 5), basedSequenceOf("\n\t  \n\t    test\n\n").leadingBlankLinesRange());
    assertEquals(
        Range.of(0, 5), basedSequenceOf("\n \t \n\t    test\n     \n").leadingBlankLinesRange());
    assertEquals(
        Range.of(0, 2), basedSequenceOf("\n\n\t    test\n     \n\n\t\n").leadingBlankLinesRange());
    assertEquals(
        Range.of(0, 6),
        basedSequenceOf("\n   \t\n\t    test\n     \n\n\t\n\t     ").leadingBlankLinesRange());
  }
  ...
  public void test_lastBlankLinesRange() {
    ...
    assertEquals(
        Range.of(12, 18), basedSequenceOf("\n\n\t    test\n     \n").trailingBlankLinesRange());
    assertEquals(
        Range.of(12, 21),
        basedSequenceOf("\n\n\t    test\n     \n\n\t\n").trailingBlankLinesRange());
    assertEquals(
  ...
  public void test_extractRanges() {
    ...
    BasedSequence sequence = basedSequenceOf(input);
    BasedSequence replaced =
        sequence.extractRanges(Range.of(0, 0), Range.of(0, 1), Range.of(3, 6), Range.of(8, 12));
  ...
  public void test_trimToEndOfLine1() {
    ...
    BasedSequence sequence = basedSequenceOf(input);
    assertEquals(
        Range.of(0, 0), sequence.trimToEndOfLine(CharPredicate.ANY_EOL, false, 0).getSourceRange());
    assertEquals(
        Range.of(0, 4), sequence.trimToEndOfLine(CharPredicate.ANY_EOL, false, 1).getSourceRange());
    assertEquals(
        Range.of(0, 4), sequence.trimToEndOfLine(CharPredicate.ANY_EOL, false, 2).getSourceRange());
    assertEquals(
        Range.of(0, 4), sequence.trimToEndOfLine(CharPredicate.ANY_EOL, false, 3).getSourceRange());
    assertEquals(
        Range.of(0, 4), sequence.trimToEndOfLine(CharPredicate.ANY_EOL, false, 4).getSourceRange());
    assertEquals(
        Range.of(0, 8), sequence.trimToEndOfLine(CharPredicate.ANY_EOL, false, 5).getSourceRange());
    assertEquals(
        Range.of(0, 8), sequence.trimToEndOfLine(CharPredicate.ANY_EOL, false, 6).getSourceRange());
    assertEquals(
        Range.of(0, 8), sequence.trimToEndOfLine(CharPredicate.ANY_EOL, false, 7).getSourceRange());
    assertEquals(
        Range.of(0, 8), sequence.trimToEndOfLine(CharPredicate.ANY_EOL, false, 8).getSourceRange());
    assertEquals(
        Range.of(0, 9), sequence.trimToEndOfLine(CharPredicate.ANY_EOL, false, 9).getSourceRange());
    assertEquals(
        Range.of(0, 9),
        sequence.trimToEndOfLine(CharPredicate.ANY_EOL, false, 10).getSourceRange());
    assertEquals(
        Range.of(0, 9),
        sequence.trimToEndOfLine(CharPredicate.ANY_EOL, false, 11).getSourceRange());
    assertEquals(
        Range.of(0, 9),
        sequence.trimToEndOfLine(CharPredicate.ANY_EOL, false, 12).getSourceRange());
    assertEquals(
        Range.of(0, 9),
        sequence.trimToEndOfLine(CharPredicate.ANY_EOL, false, 13).getSourceRange());
  }
  ...
  public void test_trimToEndOfLine3() {
    ...
    assertEquals(
        Range.of(0, 0), sequence.trimToEndOfLine(CharPredicate.ANY_EOL, false, 0).getSourceRange());
    assertEquals(
        Range.of(0, 1), sequence.trimToEndOfLine(CharPredicate.ANY_EOL, false, 1).getSourceRange());
    assertEquals(
        Range.of(0, 5), sequence.trimToEndOfLine(CharPredicate.ANY_EOL, false, 2).getSourceRange());
    assertEquals(
        Range.of(0, 5), sequence.trimToEndOfLine(CharPredicate.ANY_EOL, false, 3).getSourceRange());
    assertEquals(
        Range.of(0, 5), sequence.trimToEndOfLine(CharPredicate.ANY_EOL, false, 4).getSourceRange());
    assertEquals(
        Range.of(0, 5), sequence.trimToEndOfLine(CharPredicate.ANY_EOL, false, 5).getSourceRange());
    assertEquals(
        Range.of(0, 6), sequence.trimToEndOfLine(CharPredicate.ANY_EOL, false, 6).getSourceRange());
    assertEquals(
        Range.of(0, 10),
        sequence.trimToEndOfLine(CharPredicate.ANY_EOL, false, 7).getSourceRange());
    assertEquals(
        Range.of(0, 10),
        sequence.trimToEndOfLine(CharPredicate.ANY_EOL, false, 8).getSourceRange());
    assertEquals(
        Range.of(0, 10),
        sequence.trimToEndOfLine(CharPredicate.ANY_EOL, false, 9).getSourceRange());
    assertEquals(
        Range.of(0, 10),
        sequence.trimToEndOfLine(CharPredicate.ANY_EOL, false, 10).getSourceRange());
    assertEquals(
    ...
    assertEquals(
        Range.of(0, 12),
        sequence.trimToEndOfLine(CharPredicate.ANY_EOL, false, 14).getSourceRange());
  }
  ...
  public void test_treeSubSequence() {
    ...
    BasedSequence appended =
        sequence.getBuilder().append("> ").append(mapped).append("\n").toSequence();
    ...
    assertEquals(
        "⟦⟧> ⟦[simLink⟧ ⟦spaced](simLink.md)⟧", appendedSubBuilder.toStringWithRanges(true));
  }
}
