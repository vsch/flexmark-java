...
public class BasedSegmentBuilderTest {
    ...
    public void test_optimizersCompoundNoAnchors1() {
        String input = "" +
                ...
                "";
        BasedSequence sequence = BasedSequence.of(input);
        BasedSegmentBuilder segments = BasedSegmentBuilder.emptyBuilder(sequence, F_TRACK_UNIQUE);
...
//            if (!trim.isEmpty()) segments.append("  ");
    ...
    public void test_optimizersCompoundAnchors1() {
        String input = "" +
                ...
                "";
        BasedSequence sequence = BasedSequence.of(input);
        BasedSegmentBuilder segments = BasedSegmentBuilder.emptyBuilder(sequence, F_TRACK_UNIQUE | F_INCLUDE_ANCHORS);
    ...
    public void test_optimizersCompound3Anchors() {
        ...
        BasedSequence sequence = BasedSequence.of(input);
        CharRecoveryOptimizer2 optimizer = new CharRecoveryOptimizer2(PositionAnchor.CURRENT);
        BasedSegmentBuilder segments = BasedSegmentBuilder.emptyBuilder(sequence, optimizer, F_TRACK_UNIQUE | F_INCLUDE_ANCHORS);
