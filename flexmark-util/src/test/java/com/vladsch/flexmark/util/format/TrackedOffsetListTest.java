...
public class TrackedOffsetListTest {
  private static int[] offsets(List<TrackedOffset> trackedOffsets) {
  ...
  public void test_findTrackedOffsetBeforePrefix() {
    ...
    TrackedOffsetList trackedOffsets =
        TrackedOffsetList.create(input.trim(), new int[] {0, 2, 3, 1});
  ...
  public void test_findTrackedOffsetDoublePrefix1() {
    BasedSequence input = BasedSequence.of("* [ ] 234567  ");
    TrackedOffsetList trackedOffsets =
        TrackedOffsetList.create(input.trim(), new int[] {0, 2, 3, 1, 4, 5, 6});
