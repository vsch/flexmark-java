...
public class HtmlBuilderTest {
            ...
            fa1.withCondIndent()
                .tagLine(
                    ...
                    () -> {
                      fa1.text("item1");
                      fa1.tagIndent(
                          "ul", () -> fa1.withCondIndent().tagLine("li", () -> fa1.text("item1")));
                    }));
    assertEquals(
  ...
  public void test_Font() {
    ...
    fa.attr(font).span();
    assertEquals(
        "<span style=\"font-family:Dialog;font-size:12pt;font-style:normal;font-weight:normal\"></span>\n",
        fa.toFinalizedString());
    ...
    assertEquals(
        "<span style=\"font-family:Dialog;font-size:12pt;font-style:normal;font-weight:bold\"></span>\n",
        fa.toFinalizedString());

    fa = new HtmlBuilder();
    fa.attr(font).attr(FontStyle.PLAIN).attr(FontStyle.ITALIC).span();
    assertEquals(
        "<span style=\"font-family:Dialog;font-size:12pt;font-style:italic;font-weight:normal\"></span>\n",
        fa.toFinalizedString());

    fa = new HtmlBuilder();
    fa.attr(font).attr(FontStyle.PLAIN).attr(FontStyle.BOLD_ITALIC).span();
    assertEquals(
        "<span style=\"font-family:Dialog;font-size:12pt;font-style:italic;font-weight:bold\"></span>\n",
        fa.toFinalizedString());
    ...
    fa.attr(font)
        ...
        .attr(Color.DARK_GRAY)
        .attr(BackgroundColor.LIGHT_GRAY)
        .span();
    assertEquals(
        "<span style=\"font-family:Dialog;font-size:12pt;font-style:italic;font-weight:normal;color:#404040;background-color:#c0c0c0\"></span>\n",
        fa.toFinalizedString());
  }
}
