...
public class EditorSegmentBuilder {
    ...
    protected EditorSegmentBuilder(@NotNull Range range) {
        if (range.isNotNull()) {
            myParts.add(range);
            myStartOffset = range.getStart();
            myEndOffset = range.getEndOffset();
        }
    }

    protected EditorSegmentBuilder(@NotNull EditorSegmentBuilder other) {
     ...
     */
    @NotNull
    public EditorSegmentBuilder append(int startOffset, int endOffset) {
    ...
    public Range getOffsetRange() {
        ...
        assert range.equals(getOffsetRangeComputed());
        return range;
    }

    @NotNull
    private Range getOffsetRangeComputed() {
...
//            // fully contains added range, ignore
     ...
     */
    @NotNull
    public EditorSegmentBuilder append(@Nullable Range range) {
    ...
    @NotNull
    public EditorSegmentBuilder append(@Nullable String text) {
        if (text != null && !text.isEmpty()) {
    ...
    @NotNull
    public EditorSegmentBuilder append(@Nullable Object part) {
        if (part != null) {
     ...
     */
    @NotNull
    public EditorSegmentBuilder deleteByIndices(int startIndex, int endIndex) {
     ...
     */
    @NotNull
    public EditorSegmentBuilder deleteByLength(int startIndex, int count) {
     ...
     */
    @NotNull
    public EditorSegmentBuilder delete(@NotNull Range range) {
        int startOffset = 0;
     ...
     * @return this
     */
    public EditorSegmentBuilder insert(int atIndex, @NotNull String text) {
        int startOffset = 0;
    ...
    @NotNull
    public static EditorSegmentBuilder emptyBuilder() {
        return new EditorSegmentBuilder(Range.NULL);
    }

    @NotNull
    public static EditorSegmentBuilder rangeBuilder(@NotNull Range range) {
        return new EditorSegmentBuilder(range);
    }

    @NotNull
    public static EditorSegmentBuilder rangeBuilder(int startOffset, int endOffset) {
        startOffset = Math.max(0, startOffset);
        endOffset = Math.max(startOffset, endOffset);
        return new EditorSegmentBuilder(Range.of(startOffset, endOffset));
    }

    @NotNull
    public static EditorSegmentBuilder sequenceBuilder(@NotNull CharSequence sequence) {
        return new EditorSegmentBuilder(Range.of(0, sequence.length()));
    }

    @NotNull
    public static EditorSegmentBuilder copyBuilder(@NotNull EditorSegmentBuilder other) {
        return new EditorSegmentBuilder(other);
    }
}
