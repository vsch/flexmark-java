 ...
 * access implemented as a binary search tree of segments
 */
public final class SegmentedSequenceTree extends BasedSequenceImpl implements ReplacedBasedSequence {
    ...
    private SegmentedSequenceTree(BasedSequence baseSeq, int startOffset, int endOffset, int length, boolean nonBaseChars, int[] baseOffsets, int baseStartOffset) {
        super(0);
     ...
     */
    static SegmentedSequenceTree create(IBasedSegmentBuilder<?> builder) {
    ...
    private SegmentedSequenceTree subSequence(final BasedSequence baseSeq, final int[] baseOffsets, final int baseStartOffset, final boolean nonBaseChars, final int length) {
