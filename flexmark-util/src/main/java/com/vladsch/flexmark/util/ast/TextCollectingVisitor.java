...
public class TextCollectingVisitor {
    ...
    static class SpaceInsertingSequenceBuilder implements ISequenceBuilder<SpaceInsertingSequenceBuilder, BasedSequence> {
        final SequenceBuilder out;
        Node lastNode;
        boolean addSpaceOnNonBlank;
        boolean needEol;

        public SpaceInsertingSequenceBuilder(SequenceBuilder out) {
            this.out = out;
        }
        ...
        @Override
        public boolean isNotEmpty() {return out.isNotEmpty();}
    }
    ...
    public void collect(Node node, int flags) {
        builder = SequenceBuilder.emptyBuilder(node.getChars());
        out = new SpaceInsertingSequenceBuilder(builder);
