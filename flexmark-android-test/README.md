...
2. Be sure that SDK Platform 16 and emulator for this platform (system image) are installed. It's recommended to use x86
...
# Version number of flexmark and extensions in maven central.
version.maven=0.7.1
# Version number of autolink in maven central (not bundled with extension jar).
version.maven_autolink=0.4.0

# Version number of flexmark and extensions in project.
...
If you're going to test on device with Android 16 then you can skip downloading emulator.
