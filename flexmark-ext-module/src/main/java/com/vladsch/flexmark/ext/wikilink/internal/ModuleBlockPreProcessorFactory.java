...
public class ModuleBlockPreProcessorFactory implements BlockPreProcessorFactory {
    @Override
    ...
    public BlockPreProcessor create(ParserState state) {
        return new BlockPreProcessor() {
            ...
            public Block preProcess(Block block) {
                ...
                if (taskListMarker instanceof Module) {
                    // convert it to a task list item
                    return new ModuleBlock(taskListMarker);
                }
                return block;
            }
        };
