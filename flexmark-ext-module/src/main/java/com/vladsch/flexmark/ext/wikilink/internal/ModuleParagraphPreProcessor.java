...
public class ModuleParagraphPreProcessor implements ParagraphPreProcessor {
    ...
    public static ParagraphPreProcessorFactory Factory() {
        return new ParagraphPreProcessorFactory() {
            ...
            public ParagraphPreProcessor create(ParserState state) {
                return new ModuleParagraphPreProcessor(state.getProperties());
            }
        };
    }
    ...
    private ModuleParagraphPreProcessor(DataHolder options) {
        this.options = new ModuleOptions(options);
    }

    private ModuleParagraphPreProcessor(ModuleOptions options) {
