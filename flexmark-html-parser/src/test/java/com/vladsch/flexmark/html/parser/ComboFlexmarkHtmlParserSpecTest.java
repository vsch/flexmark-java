...
public class ComboFlexmarkHtmlParserSpecTest extends ComboSpecTestCase {
    private static final String SPEC_RESOURCE = "/flexmark_html_parser_ast_spec.md";
    ...
    public ComboFlexmarkHtmlParserSpecTest(SpecExample example) {
        super(example);
    }
