...
public class ComboAdmonitionSpecTest extends ComboSpecTestCase {
    private static final String SPEC_RESOURCE = "/admonition_ast_spec.md";
    ...
    public ComboAdmonitionSpecTest(SpecExample example) {
        super(example);
    }
