        ...
        // , Parser.ReferenceHoldingExtension
{
    ...
    public static final DataKey<Map<String, String>> QUALIFIER_TYPE_MAP = new DataKey<Map<String, String>>("ADMONITION.QUALIFIER_TYPE_MAP", getQualifierTypeMap());
    public static final DataKey<Map<String, String>> QUALIFIER_TITLE_MAP = new DataKey<Map<String, String>>("ADMONITION.QUALIFIER_TITLE_MAP", getQualifierTitleMap());
    public static final DataKey<Map<String, String>> TYPE_SVG_MAP = new DataKey<Map<String, String>>("ADMONITION.TYPE_SVG_MAP", getQualifierSvgMap());

    private static DataValueFactory<Map<String, String>> getQualifierTypeMap() {
    ...
    private static DataValueFactory<Map<String, String>> getQualifierTitleMap() {
        return new DataValueFactory<Map<String, String>>() {
            @Override
            public Map<String, String> create(final DataHolder value) {
    ...
    private static DataValueFactory<Map<String, String>> getQualifierSvgMap() {
        return new DataValueFactory<Map<String, String>>() {
            @Override
            public Map<String, String> create(final DataHolder value) {
