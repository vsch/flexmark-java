        ...
        // , PhasedNodeRenderer
{
    ...
    public Set<NodeRenderingHandler<?>> getNodeRenderingHandlers() {
        return new HashSet<>(Arrays.asList(
                new NodeRenderingHandler<>(AutoLink.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(BlockQuote.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(BulletList.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(BulletListItem.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(Code.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(Document.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(Emphasis.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(FencedCodeBlock.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(HardLineBreak.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(Heading.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(HtmlBlock.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(HtmlCommentBlock.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(HtmlEntity.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(HtmlInline.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(HtmlInlineComment.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(HtmlInnerBlock.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(HtmlInnerBlockComment.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(Image.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(ImageRef.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(IndentedCodeBlock.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(Link.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(LinkRef.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(MailLink.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(OrderedList.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(OrderedListItem.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(Paragraph.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(Reference.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(SoftLineBreak.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(StrongEmphasis.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(Text.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(TextBase.class, YouTrackConverterNodeRenderer.this::render),
                new NodeRenderingHandler<>(ThematicBreak.class, YouTrackConverterNodeRenderer.this::render)
        ));
    }
